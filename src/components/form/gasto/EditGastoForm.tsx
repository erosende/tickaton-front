...
interface EditGastoFormProps {
  idGrupoGasto: number;
  gasto?: Gasto;
  onSave: (data: Gasto) => void;
  personas: Persona[];
}

const EditGastoForm = ({ idGrupoGasto, gasto, onSave, personas }: EditGastoFormProps) => {
    ...
    <div>
      <form className="edit-gasto-form">
        ...
        <div className="form-actions">
          <button type="button" className="save-button " disabled={isSubmitDisabled} onClick={() => onSave(formData)}>
            Guardar
          </button>
        </div>
